...
public class ProdutosEstoque extends javax.swing.JFrame {
    ...
    private void lblMaxMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaxMousePressed
        if (ProdutosEstoque.this.getExtendedState() == MAXIMIZED_BOTH) {
            ProdutosEstoque.this.setExtendedState(JFrame.NORMAL);
        } else {
            ProdutosEstoque.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinMousePressed
        ProdutosEstoque.this.setState(Frame.ICONIFIED);
