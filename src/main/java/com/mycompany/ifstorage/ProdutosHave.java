 ...
 * @author khadu
 */
public class ProdutosHave extends javax.swing.JFrame {
    ...
    private void lblMaxMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaxMousePressed
        if (ProdutosHave.this.getExtendedState() == MAXIMIZED_BOTH) {
            ProdutosHave.this.setExtendedState(JFrame.NORMAL);
        } else {
            ProdutosHave.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinMousePressed
        ProdutosHave.this.setState(Frame.ICONIFIED);
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutosHave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProdutosHave().setVisible(true);
            }
        });
    }
